...
mapping_limit_per_char_i = 1
score_id = 0
for i_retry in range(1,n_retry):
    
    if i_retry in mapping_limit_per_char:
        mapping_limit_per_char_i = mapping_limit_per_char[i_retry]
    if i_retry in score_id_per_loop:
        score_id = score_id_per_loop[i_retry]
        ...
        with Pool() as p:
            ...
            for i_charB in range(maxrange_to_tryB):
                ...
                if valid_try:
                    ...
                    #Calcule les scores
                    params = mats[langB], mapped_mat, rank_to_charsB, len_intval
                    #process_params.append(params)
                    cov_scores = p.apply_async(basic_compute_coverages, params)
            ...
            for i_charB in range(maxrange_to_tryB):
                ...
                partial_word_coverage, full_word_coverage, found_words = cov_scores
